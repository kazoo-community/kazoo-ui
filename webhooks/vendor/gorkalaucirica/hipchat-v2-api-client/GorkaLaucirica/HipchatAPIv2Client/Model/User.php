...
class User
{
	...
	$this->presence->client = $json['presence']['client'];
	$this->presence->isonline = $json['presence']['is_online'];
        $this->presence->status = $json['presence']['status'];
        $this->presence->show= $json['presence']['show'];
        if (isset($json['links'])) {
	...
	$json['presence']['client'] = $this->presence->client;
	$json['presence']['is_online'] = $this->presence->isonline;
	$json['presence']['status'] = $this->presence->status;
	$json['presence']['show'] = $this->presence->show;
	$json['id'] = $this->id;

        $file_handle = fopen('/tmp/webhook.json', 'a');
        fwrite($file_handle, "json: ".print_r($json,true));
        fwrite($file_handle, "\r\n");
        fclose($file_handle);
