winkstart.module('fax_in', 'fax_in', {
//        css: {
 //           fax: 'css/fax.css'
   //     },
   ...
   //     },
        ...
        subscribe: {
            'fax_in.activate' : 'activate',
            'fax_in.initialized' : 'initialized',
            'fax_in.module_activate': 'module_activate'
        }
    },
    ...
    function() {
        ...
        winkstart.publish('fax_in.loaded');
    },
    {
        ...
        initialized: function() {
            ...
            if(winkstart.apps['fax_in']['default']) {
                $('[data-whapp="fax_in"] > a').addClass('activate');
                THIS.setup_page();
            }
        },
        ...
        //  $('#ws-content').empty()
        //                    .append(THIS.templates.fax_in.tmpl());
		winkstart.publish('fax_in.module_activate', {name: 'faxes_in'});
        }
        /* End copy and paste */
    }
);
