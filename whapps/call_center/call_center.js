    winkstart.module('call_center', 'call_center', {
        subscribe: {
            'call_center.activate' : 'activate',
            'call_center.initialized' : 'initialized',
            'call_center.module_activate': 'module_activate',
        }
    },
    ...
    },
    {
        ...
        initialized: function() {
            ...
            if(winkstart.apps['call_center']['default']){
                THIS.setup_page();
                $('[data-whapp="call_center"] > a').addClass('activate');
            }
        },
