window.translate['account'] = {
	...
	caller_id_name_data_content: "Define the Caller ID Name of this Account for In-House Calls. If the Caller ID Name of the device and of the user is not set, this Caller ID Name will be used.",
	...
	caller_id_name_data_content2: "Define the Caller ID Name of this Account for Outbound Calls. If the Caller ID Name of the device and of the user is not set, this Caller ID Name will be used.",
	...
	emergency: "Emergency",
	caller_id_name_data_content3: "Define the Caller ID Name of this Account for Emergency Calls.",
