window.translate['vmbox'] = $.extend(true, {}, window.translate['vmbox'], {
	...
	max_message_length: 'Максимальная длина сообщения голосовой почты (в секундах)',
	operator_number: 'номер оператора',
	operator_number_data_content: 'Если присутствует, вызывающий абонент может нажать 0 во время запроса голосовой почты для направления оператору'
});
