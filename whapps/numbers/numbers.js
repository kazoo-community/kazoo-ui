winkstart.module('numbers', 'numbers', {
	subscribe: {
		'numbers.activate' : 'activate',
		'numbers.initialized' : 'initialized',
		'numbers.module_activate': 'module_activate',
	}
},
...
},
{
	...
	setup_page: function() {
		...
		winkstart.publish('numbers.module_activate', {name: 'numbers_manager'});
	}
}
);
